...
class GeocodableApiValuesTest extends SapphireTest
{
    ...
    public function setUp() : void {
        ...
        Config::modify()->set( GoogleGeocodeService::class, 'google_api_key', $this->googleGeocodeServiceApiKey );
        Config::modify()->set( 'Symbiote\\Addressable\\GeocodeService', 'google_api_key', $this->geocodeServiceApiKey );
        Config::modify()->set( GoogleGeocodeService::class, 'google_api_url', $this->googleGeocodeServiceApiUrl );
        Config::modify()->set( 'Symbiote\\Addressable\\GeocodeService', 'google_api_url', $this->geocodeServiceApiUrl );
    }
    ...
    public function tearDown() : void {
        ...
        Config::modify()->set( GoogleGeocodeService::class, 'google_api_key', null );
        Config::modify()->set( 'Symbiote\\Addressable\\GeocodeService', 'google_api_key', null );
        Config::modify()->set( GoogleGeocodeService::class, 'google_api_url', null );
        Config::modify()->set( 'Symbiote\\Addressable\\GeocodeService', 'google_api_url', null );
    }
    ...
    public function testApiKeySetGet() {
        ...
        // empty string value
        Environment::setEnv('GOOGLE_API_KEY', false);
        Config::modify()->set( GoogleGeocodeService::class, 'google_api_key', '' );
        $key = $service->getApiKey();
    ...
    public function testApiUrlSetGet() {
        ...
        // empty string value
        Config::modify()->set( GoogleGeocodeService::class, 'google_api_url', '' );
        $url = $service->getApiUrl();
