...
class AddressableTest extends SapphireTest
{
    ...
    {
        Config::modify()->set(Addressable::class, 'allowed_countries', [
            'au' => 'Australia',
        ]);
        $record = new AddressableDataObjectTest();
    ...
    {
        Config::modify()->set(AddressableDataObjectTest::class, 'allowed_countries', [
            'nz' => 'New Zealand',
        ]);
        $record = new AddressableDataObjectTest();
    ...
    {
        Config::modify()->set(Addressable::class, 'allowed_states', [
            'vic' => 'Victoria',
        ]);
        $record = new AddressableDataObjectTest();
    ...
    {
        Config::modify()->set(AddressableDataObjectTest::class, 'allowed_states', [
            'nsw' => 'New South Wales',
        ]);
        $record = new AddressableDataObjectTest();
